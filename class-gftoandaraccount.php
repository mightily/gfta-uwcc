...
class GFtoAndarAccount extends GFAddOn {

	protected $_version = GF_SIMPLE_FIELD_ADDON_VERSION;
	protected $_min_gravityforms_version = '1.9';
	protected $_slug = 'gftoandaraccount';
	protected $_path = 'gftoandaraccount/gftoandaraccount.php';
	protected $_full_path = __FILE__;
	protected $_title = 'Gravity Forms to Andar Contact';
	protected $_short_title = 'Andar Contact Field';
	...
	public function pre_init() {
		...
		if ( $this->is_gravityforms_supported() && class_exists( 'GF_Field' ) ) {
			require_once( 'includes/class-andar-account-field.php' );
		}
	}
...
//				'deps'    => array( 'jquery' ),
//				'enqueue' => array(
//					array( 'field_types' => array( 'andarcontact' ) ),
//				),
//			),
//
//		);
...
//	}
	...
	public function tooltips( $tooltips ) {
		$simple_tooltips = array(
			'input_class_setting' => sprintf( '<h6>%s</h6>%s', esc_html__( 'Input CSS Classes', 'gftoandaraccount' ), esc_html__( 'The CSS Class names to be added to the field input.', 'gftoandaraccount' ) ),
		);
		...
		if ( $position == 250 ) {
			...
			<li class="input_class_setting field_setting">
				<label for="input_class_setting">
					<?php esc_html_e( 'Input CSS Classes', 'gftoandaraccount' ); ?>
